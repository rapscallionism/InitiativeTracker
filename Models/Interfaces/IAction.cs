namespace Turn_Based_Game.Models.Interfaces
{
    public interface IAction
    {
        ...
        /// <summary>
        ///     Defines the implementation of the Action when used.
        /// </summary>
        /// <param name="affectedCreatures">Dictionary containing affected creatures by activation of the action</param>
        /// <returns>Dictionary which contains the affected creatures by said action. The 0th entry represents the creature that is using said action</returns>
