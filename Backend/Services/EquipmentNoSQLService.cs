...
public class EquipmentNoSQLService : IEquipmentNoSQLService
{

    private readonly IEquipmentRepository _equipmentRepository;
    private readonly ILogger<EquipmentNoSQLService> _logger;
    private readonly IConfiguration _configuration;
    public EquipmentNoSQLService(IEquipmentRepository repository, ILogger<EquipmentNoSQLService> logger, IConfiguration configuration)
    {
